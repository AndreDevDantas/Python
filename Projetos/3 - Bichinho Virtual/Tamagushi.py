class Tamagushi:
  ...
  __saude = 80 #100 é 100% saudavel
  __humor = 0
  __tedio = 75 #100 é 100% animado/sem tedio
  vivo = True
  ...
  def status(self):
    ...
    #Tedio
    if(self.__tedio <= 0):
      print(f'{self.__nome} literalmente morreu de tedio')
      morreu = True
  ...
  def run_acoes(self, comando):
    if(comando == 'a'):
      bichinho.alimentar(int(input(f'Digite o quanto você gostaria de alimentar {self.__nome} (1 a 100): ')))
      print(f'Você alimentou {self.__nome}!\n')
      print(bichinho.status())
    elif(comando == 'b'):
      bichinho.brincar(int(input(f'Digite por quantos minutos gostaria de brincar com {self.__nome} (1 a 100): ')))
      print(f'Você passou {comando} minutos brincando com {self.__nome}!\n')
      print(bichinho.status())
    elif(comando == 'd'):
      bichinho.descansar(int(input(f'Digite por quantos minutos gostaria {self.__nome} descanse (1 a 100): ')))
      print(f'Você passou {comando} minutos brincando com {self.__nome}!\n')
      print(bichinho.status())
    elif(comando == 'PortaSecreta'):
      bichinho.PortaSecreta()
      print('\n')
    else:
...
print(bichinho.menu())
while bichinho.vivo == True:
  print(bichinho.status())
  inserir_comando = bichinho.run_acoes(input('Digite o que você quer fazer com seu bichinho: '))
  if(bichinho.vivo == False):
    break
